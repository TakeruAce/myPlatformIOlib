...
#define MAX_DMP_SAMPLE_RATE 1000 // Maximum sample rate for the DMP FIFO (200Hz)
#define FIFO_BUFFER_SIZE 128 // Max FIFO buffer size
...
public:
	...
	inv_error_t begin(unsigned char address);
