...
class MaxonMotor {
    public:
        MaxonMotor(int PWM1, int PWM2, uint8_t SS_PIN, float gear_ratio, float KP, float KI, float KD, float KF, bool reversed, bool isTorqueMode_, uint8_t enc_id, bool is3A_,bool is_param_identify_, float count_per_rev, float speed_filter_gain_) {
            ...
            speed_filter_gain = speed_filter_gain_;
        }
        void setup();
        void update();
        void updatePosition();
